...
/**
 * Форма в виде "меню", на которой пользователь выбирает свои дальнейшие действия. На ней также показана основная
 * информация для пользователя. Является первой формой, которая показывается пользователю, "стартовая" форма.
 */
